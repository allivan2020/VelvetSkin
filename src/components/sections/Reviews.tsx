...
const reviews = [
  {
    ...
    source: 'Instagram',
    link: 'https://instagram.com/sandy_waxing',
  },
  {
    id: 2,
    name: 'Аліна',
    text: 'Найкраща студія в Запоріжжі! Атмосфера просто супер, кабінет дуже чистий, матеріали преміум. Результат тримається довше, ніж після шугарингу.',
        ...
        <div className="relative h-[420px] w-full max-w-5xl mx-auto flex justify-center items-center touch-pan-y mb-10">
          <AnimatePresence initial={false}>
            {reviews.map((review, index) => {
              // Высчитываем позицию карточки относительно активной (для зацикливания)
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <p className="font-cormorant italic text-[18px] md:text-[20px] leading-[1.6] text-[#4a3f39] mt-6 mb-6 relative z-10">
                      {review.text}
                    </p>
                  </div>
